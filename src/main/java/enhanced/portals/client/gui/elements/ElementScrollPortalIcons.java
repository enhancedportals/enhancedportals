...
public class ElementScrollPortalIcons extends BaseElement {
    ...
    protected void handleMouse() {
        ...
        if (isScrolling) {
            ...
            int max = ProxyClient.customPortalTextures.size() - 27;
    ...
    protected void drawContent() {
        ...
        if (ProxyClient.customPortalTextures.size() > 27) {
            canScroll = true;
            handleMouse();
        }
        ...
        for (int i = 0; i < 27; i++) {
            ...
            parent.drawIcon(ProxyClient.customPortalTextures.get(scrollAmount + i), x, y, 0);
        }
    }
