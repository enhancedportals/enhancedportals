...
public class ElementScrollFrameIcons extends BaseElement {
    ...
    public boolean handleMouseClicked(int x, int y, int mouseButton) {
        ...
        for (int i = 0; i < 27; i++) {
            if (scrollAmount + i >= ProxyClient.customFrameTextures.size())
                break;
    ...
    protected void handleMouse() {
        ...
        if (isScrolling) {
            ...
            int max = ProxyClient.customFrameTextures.size() - 27;
    ...
    protected void drawContent() {
        ...
        if (ProxyClient.customFrameTextures.size() > 27) {
            canScroll = true;
            handleMouse();
        }
        ...
        for (int i = 0; i < 27; i++) {
            ...
            parent.drawIcon(ProxyClient.customFrameTextures.get(scrollAmount + i), x, y, 0);
        }
    }
