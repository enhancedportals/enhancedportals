...
public class EntityManager {
    ...
    public static void setEntityPortalCooldown(Entity entity) {
        ...
        if (CommonProxy.CONFIG_FASTER_PORTAL_COOLDOWN || entity instanceof EntityPlayer || entity instanceof EntityMinecart || entity instanceof EntityBoat || entity instanceof EntityHorse)
